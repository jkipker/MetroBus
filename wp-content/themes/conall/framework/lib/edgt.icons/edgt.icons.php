...
if ( ! function_exists( 'conall_edge_activate_theme_icons' ) ) {

    function conall_edge_activate_theme_icons() {
        global $conall_edge_IconCollections;
        $conall_edge_IconCollections = ConallEdgeClassIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'conall_edge_activate_theme_icons');
}