...
class HeaderClassic extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $logoAreaHeight       = conall_edge_filter_px(conall_edge_options()->getOptionValue('logo_area_height_header_classic'));
            $this->logoAreaHeight = $logoAreaHeight !== '' ? conall_edge_filter_px($logoAreaHeight) : 102;

            $menuAreaHeight       = conall_edge_filter_px(conall_edge_options()->getOptionValue('menu_area_height_header_classic'));
            $this->menuAreaHeight = $menuAreaHeight !== '' ? intval($menuAreaHeight) : 84;
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters = apply_filters('conall_edge_header_classic_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } else if (conall_edge_options()->getOptionValue('menu_area_background_transparency_header_classic') !== '1' && conall_edge_options()->getOptionValue('menu_area_background_transparency_header_classic') !== '') {
            $menuAreaTransparent = true;
        } else {
