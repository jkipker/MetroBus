...
class HeaderStandard extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = conall_edge_filter_px(conall_edge_options()->getOptionValue('menu_area_height_header_standard'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters = apply_filters('conall_edge_header_standard_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        if(get_post_meta($id, 'edgtf_menu_area_background_transparency_header_standard_meta', true) !== '1' && get_post_meta($id, 'edgtf_menu_area_background_transparency_header_standard_meta', true) !== ''){
            $menuAreaTransparent = true;
        } else if (conall_edge_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '1' && conall_edge_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '') {
            $menuAreaTransparent = true;
        } else {
