...
if ( ! function_exists('conall_edge_contact_form_7_options_map') ) {

	function conall_edge_contact_form_7_options_map() {
		...
		$panel_contact_form_style_1 = conall_edge_add_admin_panel(array(
		...
		$typography_text_group = conall_edge_add_admin_group(array(
		...
		$typography_text_row1 = conall_edge_add_admin_row(array(
		...
		$typography_text_row2 = conall_edge_add_admin_row(array(
		...
		$typography_text_row3 = conall_edge_add_admin_row(array(
		...
		$typography_label_group = conall_edge_add_admin_group(array(
		...
		$typography_label_row1 = conall_edge_add_admin_row(array(
		...
		$typography_label_row2 = conall_edge_add_admin_row(array(
		...
		$background_border_group = conall_edge_add_admin_group(array(
		...
		$background_border_row1 = conall_edge_add_admin_row(array(
		...
		$background_border_row2 = conall_edge_add_admin_row(array(
		...
		$background_border_row3 = conall_edge_add_admin_row(array(
		...
		$padding_group = conall_edge_add_admin_group(array(
			'name'			=> 'padding_group',
		...
		$padding_row = conall_edge_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		$margin_group = conall_edge_add_admin_group(array(
			'name'			=> 'margin_group',
		...
		$margin_row = conall_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = conall_edge_add_admin_group(array(
		...
		$button_typography_row1 = conall_edge_add_admin_row(array(
		...
		$button_typography_row2 = conall_edge_add_admin_row(array(
		...
		$button_background_border_group = conall_edge_add_admin_group(array(
		...
		$button_background_border_row1 = conall_edge_add_admin_row(array(
		...
		$button_background_border_row2 = conall_edge_add_admin_row(array(
		...
		$button_background_border_row3 = conall_edge_add_admin_row(array(
		...
		$panel_contact_form_style_2 = conall_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
        ...
        $panel_contact_form_style_3 = conall_edge_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
        ...
        $typography_label_row3 = conall_edge_add_admin_row(array(
        ...
        $button_typography_row3 = conall_edge_add_admin_row(array(
	...
	add_action( 'conall_edge_options_map', 'conall_edge_contact_form_7_options_map', 20);
}