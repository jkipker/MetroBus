<div class="edgtf-blog-holder edgtf-blog-type-split-column <?php echo esc_attr($blog_classes)?>" data-blog-type="<?php echo esc_attr($blog_type)?>" <?php echo esc_attr(conall_edge_set_blog_holder_data_params()); ?>>
	<?php
