<div class="edgtf-blog-holder edgtf-blog-type-masonry edgtf-masonry-full-width edgtf-masonry-pagination-<?php echo conall_edge_options()->getOptionValue('masonry_pagination'); ?>">
...
<?php
	if(conall_edge_options()->getOptionValue('pagination') == 'yes') {
		$pagination_type = conall_edge_options()->getOptionValue('masonry_fullwidth_pagination');
